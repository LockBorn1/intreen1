  ...
  <header class="site">
    <div class="topbar">
      <div class="container topbar-inner">
        <a href="/index.html" class="brand logo"><img src="/assets/img/main-logo.webp" alt="Intreen" style="height:32px;vertical-align:middle;border-radius:6px"/></a>
        ...
        <div class="auth" style="display:flex;gap:8px;align-items:center;justify-content:flex-end">
          <a class="btn sm" style="background:var(--brand-primary);color:#fff" href="/login.html">Log in</a>
    ...
    <nav class="menu">
      <div class="container menu-inner">
        ...
        <a href="/shop/index.html" class="${active==='shop'?'active':''}">Shop</a>
        ...
        <a href="/business/index.html" class="${active==='business'?'active':''}">Business Directory</a>
        <a href="/affiliates/index.html" class="${active==='affiliates'?'active':''}">Affiliates</a>
        <a href="/games/index.html" class="${active==='games'?'active':''}">Games</a>
        <a href="/vendor/index.html" class="${active==='vendor'?'active':''}">Register As Vendor</a>
      </div>
    </nav>
  </header>`
}
